...
def train_model(cfg: DictConfig):
    ...
    try:
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X, y, test_size=cfg.data.test_size, random_state=cfg.model.params.random_state
        )
        ...
        with mlflow.start_run():
            ...
            logger.info("Training successful", extra={"accuracy": accuracy, "model_path": model_path})
